  ...
  return (
    <div className="relative flex h-full w-full flex-col justify-end overflow-hidden rounded-sm">
      ...
      <div className="relative z-10 mb-5 flex w-full justify-center space-x-8">
        <span className="text-profileColor text-3xl font-semibold">Dimitris</span>
      </div>
      <div className="relative z-10 mb-5 flex w-full justify-center space-x-8">
        <a href="https://github.com/DimitrisKyp" target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon icon={faGithub} className="text-profileColor text-3xl transition-all duration-300 hover:scale-150" />
        </a>
        <a href="https://www.linkedin.com/in/dimitrios-kyprianou" target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon icon={faLinkedin} className="text-profileColor text-3xl transition-all duration-300 hover:scale-150" />
        </a>
        <a href="https://www.facebook.com/kyprianou.dimitris" target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon icon={faFacebook} className="text-profileColor text-3xl transition-all duration-300 hover:scale-150" />
        </a>
        <a href="https://instagram.com/dimitris.kypr" target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon icon={faInstagram} className="text-profileColor text-3xl transition-all duration-300 hover:scale-150" />
        </a>
      </div>
    </div>
  );
