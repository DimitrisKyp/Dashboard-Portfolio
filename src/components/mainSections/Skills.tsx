    ...
    <div className="flex flex-col rounded-sm bg-secondLayer p-6">
      ...
      <div className="mt-10 space-y-8 text-lg leading-relaxed text-textPrimary">
        ...
        <div className="flex space-x-4">
          <FontAwesomeIcon icon={faCode} size="xl" className="mt-1 text-button" />
          <div>
            <span className="text-2xl font-semibold text-textSecondary">Frontend Development</span>
            <p className="text-lg">
        ...
        {/* Backend Section */}
        <div className="flex space-x-4">
          <FontAwesomeIcon icon={faDatabase} size="xl" className="mt-1 text-button" />
          <div>
            <span className="text-2xl font-semibold text-textSecondary">Backend Development</span>
            <p className="text-lg">
        ...
        <div className="flex space-x-4">
          <FontAwesomeIcon icon={faMobile} size="xl" className="mt-1 text-button" />
          <div>
            <span className="text-2xl font-semibold text-textSecondary">Mobile Development</span>
            <p className="text-lg">
